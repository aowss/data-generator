...
public record Specification(List<DataSpecification> specifications, int count, FileType outputType, String outputPath) {
    public Specification {
        if (specifications == null || specifications.isEmpty()) throw new IllegalArgumentException("The data specification is mandatory and must contain at list one specification");
